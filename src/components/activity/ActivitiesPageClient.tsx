...
export function ActivitiesPageClient({ applications, userId }: ActivitiesPageClientProps) {
    ...
    if (items.length === 0) {
        return (
            <div className="activities-empty-state text-center py-20 px-4 rounded-3xl border border-dashed border-slate-800 bg-slate-900/20">
                <div className="activities-empty-icon bg-slate-800/50 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-slate-500">
                    <Briefcase size={24} />
                </div>
    ...
    return (
        <div className="activities-surface space-y-6 h-[calc(100vh-140px)] flex flex-col">
            ...
            <div className="grid grid-cols-3 gap-4 shrink-0">
                <div className="activity-stat-card bg-[#111116] border border-white/5 p-4 rounded-2xl relative overflow-hidden group">
            ...
            <div className="activity-shell flex-1 flex bg-[#09090b] rounded-3xl border border-white/10 overflow-hidden shadow-2xl min-h-0">

                {/* LIST View (Sidebar on Desktop, Full on Mobile if no selection) */}
                <div className={cn(
                    "activity-sidebar w-full md:w-[350px] lg:w-[400px] border-r border-white/5 flex flex-col bg-[#111116]",
                    selectedAppId ? "hidden md:flex" : "flex"
                )}>
                    <div className="activity-sidebar-header p-4 border-b border-white/5 bg-[#111116] z-10">
                ...
                <div className={cn(
                    "activity-chat-panel flex-1 flex flex-col bg-[#09090b]",
                    ...
                    {selectedApp ? (
                        ...
                        <div className="activity-empty-detail flex-1 flex flex-col items-center justify-center text-slate-500 p-8 text-center bg-[#09090b]">
                            <div className="activity-empty-icon w-16 h-16 rounded-full bg-[#111116] border border-white/5 flex items-center justify-center mb-4 text-slate-600">
                                <MessageSquare size={32} />
                            </div>
